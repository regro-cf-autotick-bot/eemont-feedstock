...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/eemont-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12635&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/eemont-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `eemont` can be installed with:

```
conda install eemont
```

It is possible to list all of the versions of `eemont` available on your platform with:
